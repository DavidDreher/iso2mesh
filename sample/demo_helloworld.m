...
[node,elem,face]=iso2mesh.v2m(hw3d,0.7,5,40);
%                             |  |-> maximum volume
%                             |----> maximum surface triangle size

figure;
subplot(211);
iso2mesh.plotmesh(node,face);axis equal;view(90,60);
subplot(212);
iso2mesh.plotmesh(node,elem,'z<20');axis equal;view(90,60);

% mesh with denser surface    |----> surface triangle size is now 2
[node,elem,face]=iso2mesh.v2m(hw3d,0.7,2,40);
...
[node,elem,face]=iso2mesh.v2m(hw3d,128,2,40);
...
opt.autoregion=1;
[node,elem,face]=iso2mesh.v2m(hw3d,128,opt,40);
